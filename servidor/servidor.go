...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = json.Unmarshal(corpoRequisicao, &usuario); erro != nil {
		w.Write([]byte("Falha ao converter o usuaário para struct!"))
		return
	}
	...
	if erro != nil {
		w.Write([]byte("Falha ao obter o último id inserido!"))
		return
	}
...
// BuscarUsuarios exibe todos os usuários cadastrados
...
// BuscarUsuario exibe somente o usuário informado
...
// AtualizarUsuario atualiza o usuário informado
...
// DeletarUsuario exclui o usuário informado
